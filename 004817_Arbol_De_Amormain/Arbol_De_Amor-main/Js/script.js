...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con mucho cariño, jeremy";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Tiempo que nos cocimos 📅: <b>${days}</b> días<br>` 
